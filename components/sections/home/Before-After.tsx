...
const beforeAfterImages: BeforeAfterImageProps[] = [
  {
    beforeSrc: "/placeholder.svg?height=400&width=600",
    afterSrc: "/placeholder.svg?height=400&width=600",
      ...
      <div className="relative h-[400px] w-full overflow-hidden rounded-lg">
        ...
        >
          ...
          <div className="absolute inset-0">
            <img src={beforeSrc || "/placeholder.svg"} alt="Before treatment" className="h-full w-full object-cover" />
          </div>
