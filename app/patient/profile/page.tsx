...
// Add this mock data object at the top of the file, right after the imports
const mockData = {
  personalInfo: {
    firstName: "John",
    lastName: "Doe",
...
export default function MyProfilePage() {
  // Replace the useState initialization with the mock data
  const [userInfo, setUserInfo] = useState(mockData.personalInfo);
  ...
  // Create these components right before the main component return statement
            ...
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <span className="text-lg dark:text-white">
                {new Date().getFullYear() -
                  new Date(userInfo.dob).getFullYear()} years old
              </span>
            </div>
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl">
              <Phone className="h-6 w-6 text-green-500" />
              <span className="text-lg dark:text-white">{userInfo.phone}</span>
            </div>
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl">
              <Mail className="h-6 w-6 text-purple-500" />
              <span className="text-lg dark:text-white">{userInfo.email}</span>
            </div>
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl">
            ...
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  {mockData.insuranceInfo.provider}
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              ...
              <div>
                <p className="font-semibold dark:text-white">Policy Number:</p>
                <p className="text-gray-700 dark:text-gray-300">
                  {mockData.insuranceInfo.policyNumber}
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              ...
              <div>
                <p className="font-semibold dark:text-white">Group Number:</p>
                <p className="text-gray-700 dark:text-gray-300">
                  {mockData.insuranceInfo.groupNumber}
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  {mockData.insuranceInfo.coveragePeriod}
                </p>
              </div>
            </div>
          </div>
  ...
  const ProfileEdit = ({ userInfo, handleInputChange, handleSaveChanges }) => (
    <Card className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-lg border-none shadow-xl">
      <CardHeader>
        <CardTitle className="text-3xl font-bold text-gray-800 dark:text-white">
    ...
    <Card className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-lg border-none shadow-xl">
      ...
      <CardContent className="space-y-8">
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
            <Label htmlFor="sms-reminders" className="text-lg dark:text-white">
              SMS Reminders
            </Label>
            <Switch id="sms-reminders" />
          </div>
          <div className="flex items-center justify-between bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
            <Label htmlFor="push-reminders" className="text-lg dark:text-white">
              Push Notifications
            </Label>
