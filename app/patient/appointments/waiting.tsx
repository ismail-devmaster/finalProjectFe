...
export default function Waiting({ waitingAppointments, handleReschedule, handleCancel }: WaitingProps) {
  return (
        ...
        return (
          <Card key={appointment.id} className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent className="pt-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{appointment.action.appointmentType.type}</p>
            </CardContent>
